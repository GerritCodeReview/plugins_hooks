...
public class RefOperate implements RefOperationValidationListener {
  private final SynchronousHook hook;
  private final HookFactory hookFactory;

  @Inject
  RefOperate(HookFactory hookFactory) {
    this.hook = hookFactory.createSync("refOperateHook", "ref-operate");
  ...
  public List<ValidationMessage> onRefOperation(RefReceivedEvent refEvent)
    ...
    IdentifiedUser user = refEvent.user;
